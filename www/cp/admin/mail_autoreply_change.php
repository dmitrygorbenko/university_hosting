<?php
	...
	function body_page() {
		...
		$data = $HM->MC->fetch_mail_autoreply($id);
		if ($data == FALSE) {
			echo "Can't fetch email autoreply: ".$_SESSION["adminpanel_error"];
			return;
		}
		...
		echo "
			<form action=\"mail_autoreply_action.php?act=change_email_autoreply\" method=\"POST\" name=\"mail_autoreply_manage\">
				...
				<td colspan=\"5\" width=\"100%\">
					...
					<tr valign=\"center\" height=\"62\" width=\"100%\">
						...
						<td height=\"62\" width=\"99%\" align=\"left\" background=\"../img/table/table_background.jpg\" class=\"title\" colspan=\"3\">
							E-mail Auto Answer: <strong>".$data->email."</strong> ".$append."
						</td>
			...
			<tr valign=\"top\">
				...
				<td>
					<input type=\"checkbox\" name=\"reply_do\" ".($data->reply_do=="t"?" checked ":"").">
				</td>
			</tr>
			<tr valign=\"top\">
				<td class=\"content2\">
				...
				<td>
					<textarea name=\"reply_text\" wrap=\"physical\" class=\"textinput\" cols=\"60\" rows=\"4\">".$data->reply."</textarea>
				</td>
			</tr>
			<tr height=\"40px\">
				<td>
