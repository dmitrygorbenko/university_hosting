...
<tr width="100%">
	...
	<td width="100%" valign="top">
		...
		<tr width="100%">
			...
			<td bgcolor="#FFFFFF">
Тарифный пакет <strong>Полный</strong>:
<p>
<li>25 Mb Дискового пространства для сайта</li>
<li>5 Почтовых ящиков</li>
<li>10 Mb Для каждого почтового ящика</li>
<li>Неограниченное количество FTP аккаунтов</li>
<li>Неограниченное количество поддоменов</li>
<li>Контрольная панель</li>
<li>File-менеджер</li>
<li>Web-почта</li>
<li>Управление DNS через Web-интерфейс</li>
<li>FTP-доступ</li>
<li>IMAP/POP3-доступ</li>
<li>SMTP-доступ</li>
<li>PHP5</li>
<li>CGI/Perl</li>
<li>1 MySQL база данных</li>
<li>1 PostgreSQL база данных</li>
<li>PhpMyAdmin</li>
<li>PhpPgAdmin</li>
<li>Статистика сайта (Webalizer)</li>
<li>Паролирование директорий и файлов</li>
<li>Ежедневный Back-Up</li>
<li>Доступ к лог-файлам: Apache</li>
<li>Собственные страницы ошибок</li>
<li>Поддержка по e-mail</li>
<p>
Стоимость пакета: <strong>15 UAH</strong>
<p>
<a href="order.php?type=full">&gt;&gt;Заказать&lt;&lt;</a>
